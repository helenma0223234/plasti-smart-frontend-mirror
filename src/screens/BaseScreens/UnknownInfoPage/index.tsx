...
const UnknownInfoPage = ({ navigation, route }: UnknownInfoPageProps ) => {
  ...
  const plasticMessages = {
    first: 'This plastic type is NOT reusable.Check labels on item to confirm.',
    third: 'This plastic type is NOT reusable.Check labels on item to confirm.',
    second: 'This plastic type is usually recyclable. Check labels on item to confirm.',
    sixth: 'Avoid reusing this type of plastic.Check labels on item to confirm.',
    default: 'This type of plastic might not be good for reusing. Check labels on item to confirm.',
  };
  
  // const message = plasticMessages[selectedValue] || plasticMessages.default;
  const message = plasticMessages.default;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={[TextStyles.subTitle, { fontSize: 30, marginLeft:20, marginTop:0, marginBottom:0, fontWeight:300 }]}>Your plastic is most likely:</Text>
      </View>
      <View style={{ justifyContent: 'center', alignItems: 'center', marginHorizontal: 30, marginTop:'16%' }}>
        <Text style={[TextStyles.subTitle, { fontSize: 34, marginLeft:20, marginBottom:8 }]}>
          {plasticTypes[selectedValue]}
        </Text>
        <Text style={[TextStyles.regular, { fontSize: 20, marginTop:0, fontWeight:400 }]}>
          {message}
        </Text>
      </View>
