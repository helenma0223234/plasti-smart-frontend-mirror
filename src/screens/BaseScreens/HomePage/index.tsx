    ...
    <SafeAreaView style={{ ...FormatStyle.container, justifyContent: 'flex-start' }}>
      ...
      <ScrollView ref={scrollViewRef} style={{
        ...
        <View style={{ position: 'absolute', top: screenHeight * 0.25, left:screenWidth * 0.02 }}>
          ...
          <Avatar avatarID={user.avatarID} color={user.avatarColor} size={screenWidth * 0.47} accessory={user.avatarAccessoryEquipped} shadow={false} style={{ top: screenHeight * 0.1 }} mirror={user.avatarID == 2 || user.avatarID == 4}></Avatar>
